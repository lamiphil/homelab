...
├── metallb-system/        # Bare-metal LoadBalancer (L2 mode, IPs 192.168.0.200-220)
├── monitoring/
...
| IP | Service |
|----|---------|
| 192.168.0.200-220 | MetalLB pool range |
| .201 | Pi-hole DNS |
| .202 | Pi-hole Web UI |
| .207 | Homepage (implied) |
| .210 | Immich |
| .212 | Sonarr |
| .213 | Radarr |
| .214 | Jellyseerr |
| Auto-assigned | Jellyfin (:8096), Prowlarr (:9696), Grafana, Prometheus, Alertmanager, qUI (:7476) |
...
## NFS Storage (server: 192.168.0.144)
